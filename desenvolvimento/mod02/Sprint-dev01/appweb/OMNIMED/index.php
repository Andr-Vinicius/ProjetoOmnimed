...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
          ...
          <li class="dropdown"><a href="#"><span>Departamentos</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Médico</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="view/mod02/create_agendamento.php">Agendar uma CONSULTA</a></li>
                  <li><a href="view/mod02/view_agendamentos.php">Ver Agendamentos</a></li>
                  <li><a href="view/mod02/view_agendamentos_solicitados.php">Ver Agendamentos Solicitados</a></li>
                  <li><a href="view/mod02/view_consulta.php">Ver Consultas</a></li>
                </ul>
              </li>
      ...
      <a href="view/mod02/create_agendamento.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Agendar CONSULTA</a>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch position-relative">
            <a href="https://www.youtube.com/watch?v=QchceT9TJSI" class="glightbox play-btn mb-4"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>O que é a Telemedicina?</h3>
            <p>A telemedicina é um processo avançado para monitoramento de pacientes, troca de informações médicas e análise de resultados de diferentes exames. Estes exames são avaliados e entregues de forma digital, dando apoio para a medicina tradicional.</p>

            <div class="icon-box">
              <div class="icon"><i class="bx bx-devices"></i></div>
              <h4 class="title"><a href="">Teleconsultas</a></h4>
              <p class="description">Faça suas consutas de maneira online, desde o agendamento, até a consulta em si, por meio do Google Meet. plataforma de videochamadas.</p>
            </div>
            ...
            <div class="icon-box">
              ...
              <p class="description">Nas consultas, os médicos podem também fazer prescrições médicas, emitindo uma receita digital.</p>
            </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Serviços</h2>
          <p>O Omnimed oferece uma gama de serviços, alguns listados a seguir.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">Agendamento de Teleconsultas</a></h4>
              <p>O paciente pode acessar a plataforma e realizar um agendamento de consulta, podendo ser específica ou não.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Encaminhamentos</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Prescrições Médicas</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Cadastro de Pacientes</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Registro de Consultas</a></h4>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Medicina</h3>
                    <p>Na área de Medicina, oferecemos inúmeras outras especialidade, como Clínica Geral, Ortopedia, Pediatria, Geriatria, Ginecologia, Otorrinolaringologia.</p>
                  </div>
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Fisioterapia</h3>
                    <p>Pré-consultas para um primeiro contato do fisioterapeuta com o paciente, de forma a identificar primeiros sintomas e realizar pre-diagnósticos, afim de encaminhar para futuras sessões presenciais.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Odontologia</h3>
                    <p>Pré-consultas para um primeiro contato do dentista com o paciente, também para identificar sintomas, realizar pré-diagnósticos e encaminhar para consultas presenciais.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
          ...
          <ul>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              ...
              <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Sim. Após o agendamento, o paciente receberá um email, falando sobre o dia e o horário da consulta, além de um lembrete alertando para o paciente realizar a triagem, 1h antes da consulta.
                </p>
              </div>
            </li>
          </ul>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    Gera serviços para nós também, já que quando a demanda está alta, nós somos contratados para fazer reparos.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
