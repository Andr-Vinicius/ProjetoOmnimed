...
<body>
  ...
  <main id="main">
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <form action="../../controller/TriagemController.php" role="form" method="POST" class="php-email-form">
            ...
            <div class="row">
                <div class="form-group col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="sintomas" id="sintomas" placeholder="Descreva seus sintomas aqui..." maxlength="255" required></textarea>
                </div>
            ...
            <div class="row"> 
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input class="form-control" type="number" name="tabela_dor" id="tabela_dor" placeholder="0-10" required min="0" max="10">
                </div>

                <div class="form-group col-md-6 mb-3">
                    <label class="form-label">Temperatura (°C)</label><br/>
                    <input class="form-control" type="number" name="temperatura" id="temperatura">
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                    <label class="form-label">Pressão Sistólica</label><br/>
                    <input class="form-control" type="number" name="pressao_sistolica" id="pressao_sistolica">
                </div>
                
                <div class="form-group col-md-6 mb-3">
                    <label class="form-label">Pressão Diastólica</label><br/>
                    <input class="form-control" type="number" name="pressao_diastolica" id="pressao_diastolica">
                </div>
                
            </div>
            
            <div class="text-center"><button type="submit" id="enviarTriagem">Enviar</button></div>  
  ...
  <script src="mod02_thiago_web.js"></script>
