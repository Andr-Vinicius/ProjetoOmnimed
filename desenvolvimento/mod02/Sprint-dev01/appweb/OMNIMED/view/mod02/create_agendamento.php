    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form action="../../controller/AgendamentoController.php" method="post" role="form" class="php-email-form">
          <input type="hidden" name="acao" id="acao" value="cadastrarAgendamento">
          <input type="hidden" name="status" id="status" value="1">
          <input type="hidden" name="pacienteid" id="pacienteid" value="<?php echo $idPaciente; ?>">
          <div class="row">
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="text" name="nomecompleto" class="form-control" id="nomecompleto" placeholder="Nome Completo" disabled value="Filipe Codogno">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <select class="form-control select" name="especialidadeid" id="especialidadeid" required>
                <option disabled selected>Selecione uma especialidade médica</option>
                <?php
                $sql = "select * from tipos_especialidades_medicas";
                $resultado = mysqli_query($conexao, $sql);

                while ($row = mysqli_fetch_assoc($resultado)) {
                  echo '<option value="' . $row['TEM_ID'] . '"> ' . $row['TEM_NOME_ESPECIALIDADE'] . ' </option>';
                }
                ?>
              </select>
              <div class="validate"></div>
            ...
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="date" name="dataconsulta" class="form-control datepicker" id="dataconsulta" min="<?php echo date('Y-m-d'); ?>" required>
              <div class="validate"></div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 form-group mt-3">
              <div class="row">
                ...
                <div class="col-md-4 radio">
                  <input type="radio" name="encaminhamentos" value="1" id="encaminhamentoSim" required />Sim
            ...
            <div class="col-md-6 form-group mt-3">
              <div class="row">
                ...
                <div class="col-md-4 radio">
                  <input type="radio" name="retorno" value="1" id="retornoSim" required />Sim
