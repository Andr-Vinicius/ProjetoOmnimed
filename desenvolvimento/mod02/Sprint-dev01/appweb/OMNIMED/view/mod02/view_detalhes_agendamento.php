                ...
                <form action="" method="post" role="form" class="php-email-form">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            ID do agendamento
                            <input type="text" class="form-control" name="idAgendamento" id="idAgendamento" value="<?php echo $idAgendamento; ?>" disabled>
                        </div>
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Status do agendamento
                            <input type="text" class="form-control" name="status" id="status" value="<?php if ($agendamento['AGD_STATUS'] == 2) {
                                                                                                            echo "Agendamento confirmado";
                                                                                                        } else if ($agendamento['AGD_STATUS'] == 3) {
                                                                                                            echo "Agendamento cancelado.";
                                                                                                        } ?>" disabled>
                        </div>
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Triagem
                            <input type="text" class="form-control" name="triagem" id="triagem" value="<?php if ($agendamento['AGD_TRIAGEM_REALIZADA'] == true) {
                                                                                                            echo "Triagem realizada.";
                                                                                                        } else {
                                                                                                            echo "Triagem não realizada.";
                                                                                                        } ?>" disabled>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            ...
                            <input type="text" name="nomecompleto" class="form-control" id="nomecompleto" disabled value="<?php
                        ...
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Especialidade
                            <select class="form-control select" name="especialidadeid" id="especialidadeid" disabled>
                                <option value="<?php
                        ...
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Data da consulta
                            <input type="date" name="dataconsulta" class="form-control datepicker" id="date" value="<?php echo $agendamento['AGD_DATA']; ?>" disabled>
                            <div class="validate"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            ...
                            <input type="text" name="meetlink" class="form-control" id="meetlink" value="<?php echo $agendamento['AGD_MEET_LINK']; ?>" disabled>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Médico
                            <select class="form-control select" name="medicoid" id="medicoid" disabled>
                                <option value="<?php
                                                $sql = "SELECT AGD.FK_MEDICOS_MED_ID, MED.MED_ID, MED.MED_NOME 
                                            FROM AGENDAMENTOS AS AGD
                                            JOIN MEDICOS AS MED ON (AGD.FK_MEDICOS_MED_ID = MED.MED_ID)
                                            WHERE AGD_ID = " . $idAgendamento;
                                                $resultado = mysqli_query($conexao, $sql);
                                                $row = mysqli_fetch_assoc($resultado);
                                                echo $row['MED_ID']; ?>" selected>
                                    <?php echo $row['MED_NOME']; ?>
                                </option>
                            </select>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Horário
                            <input type="time" name="horario" class="form-control datepicker" id="horario" value="<?php echo $agendamento['AGD_HORARIO']; ?>" disabled>
                            <div class="validate"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 radio">
                                    <input type="radio" name="encaminhamentos" value="1" id="encaminhamentoSim" disabled />Sim
                        ...
                        <div class="col-md-6 form-group mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 radio">
                                    <input type="radio" name="retorno" value="1" id="retornoSim" disabled />Sim
