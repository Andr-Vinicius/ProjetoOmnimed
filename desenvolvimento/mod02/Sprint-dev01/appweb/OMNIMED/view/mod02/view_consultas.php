...
$dao = new ConsultaDAO();
$consultas = $dao->listarConsultasUltimos30Dias($idUsuario);
    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          <h2>Consultas (Últimos 30 dias)</h2>
        </div>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
                  ...
                  <tbody>
                    <?php foreach ($consultas as $consulta) { ?>
                      <tr>
                        ...
                        <td><?php echo $consulta['FK_MEDICOS_MED_ID']; ?></td>
                        <td><a href="/appweb/OMNIMED/view/mod02/view_detalhes_consulta.php">Mais Detalhes</a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
