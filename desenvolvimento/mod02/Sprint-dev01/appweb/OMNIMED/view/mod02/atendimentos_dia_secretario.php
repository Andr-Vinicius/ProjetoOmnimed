...
$data = $_GET['data'];
$nome = $_GET['nome'];
$nome_med = $_GET['nome_med'];

$consultas = $dao->listarAtendimentosDiaSecretario($data, $nome, $nome_med);
?>
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    <h2>Atendimentos do dia - Secretários</h2>

                </div>
                <div>
                    <form action="atendimentos_dia_secretario.php" method="get" role="form">
                        <div class="row">
                            <div class="col-4">
                                <label>Data</label>
                            ...
                            <div class="col-4 ">
                                ...
                                <input type="text" name="nome_med" class="form-control" id="nome_med">
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href='atendimentos_dia_secretario.php?data=&nome=' type="submit" class='btn btn-outline-light' style="border: 2px solid #0c7d78; color:#0c7d78;">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td> <?php echo $consulta['MED_NOME']; ?> </td>
