...
$agendamentos = $dao->listarAgendamentosSolicitados();
?>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#">Cadastro
              de Usuário</a></li>
            ...
            <ul>
              <li class="dropdown"><a href="#"><span>Médico</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="view_agendamentos">Ver Agendamentos</a></li>
          ...
          <tbody>
            ...
            <?php foreach ($agendamentos as $agendamento) { ?>
              <tr>
                ...
                <td><?php echo $agendamento['PAC_NOME_COMPLETO']; ?></td>
                <td>
                  <a href="confirm_agendamento.php?AGD_ID=<?php echo $agendamento['AGD_ID']; ?>">Visualizar</a>
                </td>
