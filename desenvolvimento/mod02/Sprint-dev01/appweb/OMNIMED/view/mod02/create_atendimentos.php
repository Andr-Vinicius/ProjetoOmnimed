        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <div class="section-title margem">
                    <h2>Preencher Dados da CONSULTA</h2>
                    <p>Campos a serem preenchidos pelo médico na consulta com o paciente.</p>
                </div>
                ...
                <form action="../../controller/CadAtendimentoController.php" method="post" role="form" class="php-email-form">
                    ...
                    <input type="hidden" value="1" name="fkAgendamento"/>
                    ...
                    <div class="row-md-6 form-group mt-3">
                            <div class="text-center"><button type="submit">Salvar Dados da Consulta</button></div>
                            <div class="validate"></div>
                        </div>
                </form>
