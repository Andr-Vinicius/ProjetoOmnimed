                    ...
                    <li class="dropdown"><a href="#"><span>Departamentos</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li class="dropdown"><a href="#"><span>Médico</span> <i class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li><a href="create_atendimento.php">Agendar CONSULTA</a></li>
                                    ...
                                    <li><a href="view_consultas">Ver Consultas</a></li>
                                </ul>
                            </li>
    ...
    <main id="main">
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <form action="../../controller/CadAtendimentoController.php" method="post" role="form" class="php-email-form">
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <input type="date" name="data" class="form-control" id="data" placeholder="Data da Consulta" >
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-8 form-group mt-3 mt-md-0">
                            <input type="text" class="form-control" name="anotacoes" id="anotacoes" placeholder="Anotações">
                            <div class="validate"></div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            <input type="text" class="form-control" name="sintomas" id="sintomas" placeholder="Sintomas">
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                    ...
                    <input type="hidden" value="2" name="fkAgendamento"/>
                    <input type="hidden" value="1" name="fkmedicosmedid"/>
                    <input type="hidden" value="1" name="fkpacientepacid"/>
                  
                    <div class="mb-3">
                        <div class="loading">Carregando</div>
                        <div class="error-message"></div>
                        <div class="sent-message">Sua consulta foi agendada. Muito obrigado!</div>
                    </div>
                    <div class="row-md-6 form-group mt-3">
                            <div class="text-center"><button type="submit">Registrar consulta</button></div>
                            <div class="validate"></div>
                        </div>
                </form>
                <div class="div-bt-red-atend">
                <a href="./create_prescricao.php" class="appointment-btn scrollto bt-red-atend"><span class="d-none d-md-inline">Registrar uma Prescrição</a>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <h3>Omnimed</h3>
                        <p>
                            Av Marginal 585 Fazenda Nossa Senhora Aparecida do Jaguari, 13871-298 <br> São João da Boa Vista - SP<br> Brasil <br><br>
