...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Jun-2022 às 20:35
...
(2, 'Plano BigFamília - 15 guias de exames por mês, 20 guias de consultas por mês.'),
(1, 'Plano Família - 05 guias de exames por mês, 10 guias de consultas por mês.');
...
CREATE TABLE `remedios` (
  ...
  `RMD_INDICACAO` text NOT NULL,
  `RMD_CONTRAINDICACAO` text NOT NULL,
...
--
-- Extraindo dados da tabela `uso_remedio`
--

INSERT INTO `uso_remedio` (`FK_FINALIDADE_REMEDIOS_FIN_ID`, `FK_REMEDIOS_RMD_ID`, `URM_ID`) VALUES
(5, 1, 1),
(5, 4, 4),
(1, 4, 5),
(5, 5, 6);
...
--
ALTER TABLE `beneficios`
  MODIFY `BNF_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `especialidades_medicas`
  MODIFY `ESM_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `remedios`
  MODIFY `RMD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `uso_remedio`
  MODIFY `URM_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
