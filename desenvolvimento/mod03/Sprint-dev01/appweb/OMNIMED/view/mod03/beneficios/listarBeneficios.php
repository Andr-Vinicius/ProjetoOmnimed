    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          ...
          <p>Abaixo, uma listagem dos benefícios.</p>
        </div>
        
        <a href="cadastrarBeneficios.php" class="appointment-btn scrollto">Cadastrar</a>
        <br />
        <br />
              ...
              <div class="gv">
                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                  ...
                  <?php foreach ( $dados as $dado ) { ?>
                        <tr>
                            <td><?php echo $dado[ 'BNF_DESCRICAO' ]; ?></td>
                            <td><a href="../../../controller/excluirBeneficios.php?id=<?php echo $dado['BNF_ID'];?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                            <td><a href="editarBeneficios.php?id=<?php echo $dado['BNF_ID'];?>"><span class='bi bi-pencil-square'></span></a></td>
                        </tr>
                    <?php } ?>
                  </tbody>
                </table>
