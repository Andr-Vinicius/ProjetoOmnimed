<?php 
    ...
    $beneficios->id = $_REQUEST[ 'id' ];
    $dao = new BeneficiosDAO();
    $dado = $dao->obterPorId( $beneficios );
    ...
    <section id="register" class="register section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Para editar o benefício, preencha o campo abaixo com a sua descrição.</p>
        </div>

        <a href="listarBeneficios.php" class="appointment-btn scrollto">Voltar</a>
        <br />
        <br />

        <form action="../../../controller/editarBeneficios.php" method="post" role="form" class="php-email-form">
          <div class="row">
            <input name="id" value="<?php echo $dado[ 'BNF_ID' ] ?>" hidden>
            <div class="mb-3">
              Descrição
              <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição" value="<?php echo $dado[ 'BNF_DESCRICAO' ] ?>" required>
