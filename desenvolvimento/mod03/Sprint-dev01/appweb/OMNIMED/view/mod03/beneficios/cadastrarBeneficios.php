    ...
    <section id="register" class="register section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Para cadastrar o benefício, preencha o campo abaixo com a sua descrição.</p>
        </div>
        ...
        <form action="../../../controller/cadastrarBeneficios.php" method="post" role="form" class="php-email-form">
          <div class="row">
            <div class="mb-3">
              Descrição
