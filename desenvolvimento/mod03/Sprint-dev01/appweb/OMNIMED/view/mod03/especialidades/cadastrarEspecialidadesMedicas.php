        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <div class="section-title margem">
                    ...
                    <p>Para cadastrar uma especialidade médica, preencha os campos abaixo.</p>
                </div>
                ...
                <form action="../../../controller/cadastrarEspecialidadesMedicas.php" method="post" role="form" class="php-email-form">

                    <div class="col">
                        <div class="row-md-4 form-group mt-2">
                            <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Especialidade Médica" data-rule="minlen:5" data-msg="Por favor, digite pelo menos 5 caracteres">
                        ...
                        <div class="row-md-6 form-group mt-3">
                            <div class="text-center"><button type="submit">Criar Especialidade</button></div>
                            <div class="validate"></div>
                        </div>
                    </div>
                </form>
