    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          ...
          <p>Abaixo, uma listagem das especialidades médicas.</p>
        </div>

        <a href="cadastrarEspecialidadesMedicas.php" class="appointment-btn scrollto">Cadastrar</a>
        <br />
        <br />
                ...
                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                  ...
                  <tbody>
                    <?php foreach ($dados as $dado) { ?>
                      <tr>
                        <td><?php echo $dado['ESM_DESCRICAO']; ?></td>
                        <td><a href="../../../controller/excluirEspecialidadesMedicas.php?id=<?php echo $dado['ESM_ID']; ?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                        <td><a href="editarEspecialidadesMedicas.php?id=<?php echo $dado['ESM_ID']; ?>"><span class='bi bi-pencil-square'></span></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
