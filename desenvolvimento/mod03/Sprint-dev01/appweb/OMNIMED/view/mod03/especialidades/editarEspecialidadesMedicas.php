...
$especialidades->id=$_REQUEST['id'];
$controller = new EspecialidadesMedicasDAO();
$dado = $controller->obterPorId($especialidades);
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <br><br><br><br>
                    <h2>Editar Especialidade Médica</h2>
                    <p>Para editar a especialidade médica, preencha os campos abaixo com a sua descrição.</p>
                </div>

                <a href="listarEspecialidadesMedicas.php" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />

                <form action="../../../controller/editarEspecialidadesMedicas.php" method="post" role="form" class="php-email-form">
                    <div class="row">
                        <input name="id" value="<?php echo $dado['ESM_ID'] ?>" hidden>
                        <div class="mb-3">
                            Descrição
                            <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição" value="<?php echo $dado['ESM_DESCRICAO'] ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="sent-message">A atualização foi efetuada. Muito obrigado!</div>
                        </div>
                        <div class="text-center"><button type="submit">Confirmar Atualização</button></div>
                </form>
