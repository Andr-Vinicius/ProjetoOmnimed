<?php
  ...
  $dao = new FinalidadesRemediosDAO();
    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          <h2>Gestão de Finalidade de Remédio</h2>
          <p>Abaixo, uma listagem das finalidades do remédio.</p>
        </div>
        
        <a href="cadastrarFinalidadesRemedios.php" class="appointment-btn scrollto">Cadastrar</a>
        <br />
        <br />
              ...
              <div class="gv">
                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                  ...
                  <?php foreach ( $dados as $dado ) { ?>
                        <tr>
                            <td><?php echo $dado[ 'FIN_DESCRICAO' ]; ?></td>
                            <td><a href="../../../controller/excluirFinalidadesRemedios.php?id=<?php echo $dado['FIN_ID'];?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                            <td><a href="editarFinalidadesRemedios.php?id=<?php echo $dado['FIN_ID'];?>"><span class='bi bi-pencil-square'></span></a></td>
                        </tr>
                    <?php } ?>
                  </tbody>
                </table>
