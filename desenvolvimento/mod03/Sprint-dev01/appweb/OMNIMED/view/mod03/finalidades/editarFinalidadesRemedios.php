<?php 
    ...
    $finalidades->id = $_REQUEST[ 'id' ];
    $dao = new FinalidadesRemediosDAO();
    $dado = $dao->obterPorId( $finalidades );
    ...
    <section id="register" class="register section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <br><br><br><br>
          <h2>Editar Finalidade do Remédio</h2>
          <p>Para editar a finalidade do remédio, preencha os campos abaixo com a sua descrição.</p>
        </div>
        ...
        <form action="../../../controller/editarFinalidadesRemedios.php" method="post" role="form" class="php-email-form">
          <div class="row">
            <input name="id" value="<?php echo $dado[ 'FIN_ID' ] ?>" hidden>
            <div class="mb-3">
              Descrição
              <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição" value="<?php echo $dado[ 'FIN_DESCRICAO' ] ?>" required>
