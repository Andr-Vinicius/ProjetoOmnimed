            ...
            <section id="appointment" class="appointment section-bg">
                <div class="container">
                    ...
                    <div class="section-title margem">
                        <h2>Cadastrar Planos Médicos</h2>
                        <p>Para cadastrar um plano médico, preencha os campos abaixo.</p>
                    </div>
                    ...
                    <form action="../../../controller/cadastrarPlanosMedicos.php" method="post" role="form" class="php-email-form">

                        <div class="col">
                            <div class="row-md-4 form-group mt-2">
                                Nome
                                <input type="text" name="nome" class="form-control" id="nome" placeholder="Nome do Plano" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres">
                                <div class="validate"></div>
                            </div>
                            <div class="row">
                                <div class="row-md-4 form-group mt-2">
                                    Instituição
                                    <input type="text" name="instituicao" class="form-control" id="instituicao" placeholder="Instituição Médica" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres">
                                    <div class="validate"></div>
                                </div>
                                <div class="row-md-4 form-group mt-2">
                                    Preço
                                    <input type="number" name="preco" class="form-control" id="preco" placeholder="Preço" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres" step=".01">
                                    <div class="validate"></div>
                                </div>
                                <div class="row-md-4 form-group mt-2">
                                    Valor de dependentes <a class="adicionar-dependente" title="Adicionar"><span class='bi bi-plus-circle-fill'></span></a>
                                    <div class="div-dependentes"></div>
                                    <div class="validate"></div>
                                </div>
                                <div class="row-md-4 form-group mt-2">
                                    Benefícios <a class="adicionar-beneficio" title="Adicionar"><span class='bi bi-plus-circle-fill'></span></a>
                                    <div class="div-beneficios"></div>
                                    <div class="validate"></div>
                                </div>
                            </div>
                            ...
                            <div class="row-md-6 form-group mt-3">
                                <div class="text-center"><button type="submit">Criar Plano</button></div>
                                <div class="validate"></div>
                            </div>
                        </div>
                    </form>
