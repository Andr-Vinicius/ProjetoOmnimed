...
$controller = new PlanosMedicosDAO();
$dados = $controller->listarDados();
...
<body>
    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          <h2>Planos Médicos Disponíveis</h2>
          <p>Abaixo, uma listagem dos planos médicos.</p>
        </div>

        <a href="cadastrarPlanosMedicos.php" class="appointment-btn scrollto">Cadastrar</a>
        <br />
        <br />
                ...
                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                  ...
                  <tbody>
                    <?php foreach ($dados as $dado) { ?>
                      <tr>
                        <td><?php echo $dado['PLN_NOME']; ?></td>
                        <td><?php echo $dado['PLN_INSTITUICAO']; ?></td>
                        <td><?php echo $dado['PLN_PRECO']; ?></td>
                        <td><a href="../../../controller/excluirPlanosMedicos.php?id=<?php echo $dado['PLN_ID']; ?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                        <td><a href="editarPlanosMedicos.php?id=<?php echo $dado['PLN_ID']; ?>"><span class='bi bi-pencil-square'></span></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
    ...
    $(document).ready(function() {
      $('#example').DataTable({
        ...
        "language": {
          ...
          "search": "Pesquisar:",
          "searchPlaceholder": "Instituição, Nome, Preço, ...",
          "paginate": {
            "first": "Primeiro",
            "last": "Último",
            "next": "Próximo",
  ...
  <!-- Imports do módulo -->
  <script src="../../../assets/js/mod03/exclusao.js"></script>
