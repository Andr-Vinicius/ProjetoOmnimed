    ...
    <section id="counts" class="counts">
      <div class="container">
        <div class="section-title margem">
          <h2>Medicamentos</h2>
          <p>Abaixo, uma listagem dos fármacos.</p>
        </div>

        <a href="cadastrarRemedios.php" class="appointment-btn scrollto">Cadastrar</a>
        <br />
        <br />
                ...
                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                  ...
                  <tbody>
                    <?php foreach ($dados as $dado) { ?>
                      <tr>
                        <td><?php echo $dado['RMD_NOME']; ?></td>
                        <td><?php echo $dado['FRM_DESCRICAO']; ?></td>
                        <td><?php echo $dado['RMD_DOSAGEM']; ?></td>
                        <td><a href="../../../controller/excluirRemedios.php?id=<?php echo $dado['RMD_ID'];?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                        <td><a href="../remedios/EditarRemedios.php?id=<?php echo $dado['RMD_ID'];?>"><span class='bi bi-pencil-square'></span></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
