  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="../../../index.html">Voltar ao Início</a></li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="register" class="register section-bg">
      <div class="container">
        ...
        <form action="../../../controller/cadastrarRemedios.php" method="post" role="form" class="php-email-form">
          <div class="row">
            <div class="col-md-5 form-group">
              Nome
              <input type="text" class="form-control" name="nome" id="nome" placeholder="Exemplo: Aspirina" data-rule="minlen:4" data-msg="Por favor, digite ao menos 4 caracteres">
              <div class="validate"></div>
            </div>
            <div class="col-md-3 form-group">
              Dosagem
              <input type="text" class="form-control" name="dosagem" id="dosagem" placeholder="Exemplo: 100ml">
              <div class="validate"></div>
            </div>
            ...
            <div class="col-md-6 form-group mt-3 mt-md-0">
              Indicações
              <textarea class="form-control" name="indicacao" id="indicacoes" placeholder="Exemplo: Dores agudas de cabeça" rows="3"></textarea>
              <div class="validate"></div>
            </div>
            <div class="col-md-6 form-group mt-3 mt-md-0">
              Contraindicações
              <textarea class="form-control" name="contraindicacao" id="contraindicacoes" placeholder="Exemplo: Casos de suspeita de dengue" rows="3"></textarea>
              <div class="validate"></div>
            </div>
