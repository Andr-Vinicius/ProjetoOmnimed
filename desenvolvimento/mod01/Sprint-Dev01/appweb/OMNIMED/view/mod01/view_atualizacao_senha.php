        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>Para recuperar a sua senha, preencha os campos abaixo corretamente.</p>
                </div>

                <form action="../../controller/Login/confNovaSenha.php" method="post" role="form" class="php-email-form" style="align-items: center;">
                    ...
                    <div class="row" style="margin-left: 25%;margin-right: 25%;">
                        <div class="col form-group mt-3 ml-5">
                            Confirmar Senha
                            <input type="password" class="form-control" name="conf_senha" id="conf_senha" placeholder="*********"
            ...
            <div class="text-center mt-5" style="margin-right: 5%;">
                <button type="submit" style="width: 30%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Confirmar recuperação</button>
