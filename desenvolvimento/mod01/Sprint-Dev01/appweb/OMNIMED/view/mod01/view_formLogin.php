...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="index.html" class="logo me-auto"><img src="../../assets/images/common/logo_completa_2.png" alt=""
                    class="img-fluid"></a>
            ...
            <a href="formConsulta.html" class="appointment-btn scrollto"><span class="d-none d-md-inline">Marque uma
                </span>
                CONSULTA</a>
    ...
    <main id="main">
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <form name="form_login" action="../../controller/Login/LoginController.php" method="post" role="form" class="php-email-form" style="align-items: center;">
                    <div class="row" style="margin-left: 25%;margin-right: 25%;">
                        <div class="col form-group">
                            Email ou Prontuário
                            <input type="text" name="emPront" class="form-control" id="emPront"
                                placeholder="Email/Prontuário" data-rule="minlen:4"
                    ...
                    <div class="row" style="margin-left: 25%;margin-right: 25%;">
                        ...
                        <a href="view_recSenha.php" style="text-align: center;">Recuperar Senha</a>
                    </div>
            ...
            <div class="text-center mt-5" style="margin-right: 5%;">
                <button type="submit"
                    style="width: 20%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Acessar</button>
                <a href="view_formUsuario.html"
                    style="width: 20%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Cadastre-se</a>
            </div>
            </form>
