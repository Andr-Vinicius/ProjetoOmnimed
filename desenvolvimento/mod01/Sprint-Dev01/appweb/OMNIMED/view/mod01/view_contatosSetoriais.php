<?php
include '../../DAO/ContatosSetoriaisDAO.php';

$dao = new ContatosSetoriaisDAO();
$dados = $dao->listarContatos();
?>
...
<body>
    ...
    <main id="main" style="padding-top: 20px;">
        ...
        <<div class="container">
                <div class="section-title margem">
                    <h2>Contatos Setoriais</h2>
                    <p>Abaixo, uma listagem dos contatos setoriais.</p>
                </div>
                                    ...
                                    <tbody>
                                        <?php if (count($dados) == 0) { ?>
                                            ...
                                            foreach ($dados as $dado) { ?>
                                                <tr>
                                                    <td><?php echo $dado['cse_setor']; ?></td>
                                                    <td><?php echo $dado['cse_email']; ?></td>
                                                    <td><?php echo $dado['cse_telefone_fixo']; ?></td>
                                                    <td><?php echo $dado['cse_telefone_celular']; ?></td>
                                                </tr>
                                        <?php }
                                        } ?>
                                    </tbody>
    ...
    <script>
        $(document).ready(function() {
            $('#example').DataTable({
                //dom: 'l<"top"<"right-search"f>>rt<"bottom">ip<"clear">',
