<?php
  ...
  $funcionario->fun_id = $_REQUEST['id'];


  $dao = new FuncionarioDAO();
  $dado = $dao->obterPorId($funcionario);
?>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo me-auto"><img src="../../assets/img/logo_completa_2.png" alt=""
          class="img-fluid"></a>

          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              <li><a class="nav-link scrollto active" href="#hero">Início</a></li>
              <li class="drpodown"><a href="view/mod01/view_sobreProjeto.html">Sobre o Projeto</a></li>
  ...
  <main id="main">
    ...
    <section id="register" class="register section-bg">
      <div class="container">
        ...
        <form action="../../controller/funcionarios/editarFuncionarios.php?id=<?php echo $dado['FUN_ID'];?>" method="post" role="form" class="php-email-form">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              Orgão Emissor
              <input type="text" class="form-control" name="orgaoemissor_funcionario" id="orgaoemissor_funcionario" placeholder="Orgão Emissor" data-rule="minlen:4"
                data-msg="Por favor, digite pelo menos 4 caracteres" required>
              <div class="validate"></div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              ...
              <input type="text" class="form-control" name="adm_clinica" id="adm_clinica" value="OMINMED" required>
            </div>
            <div class="col-md-4 form-group mt-3">
              Prontuário
              <input type="text" class="form-control" name="prontuario_funcionario" id="prontuario_funcionario" disabled value="Número gerado aleatóriamente de acordo com critérios" required>
            </div>
          </div>
          ...
          <div class="text-center"><button type="submit" class="appointment-btn scrollto">Salvar Alterações</button></div>
        </form>
        <br>
