          ...
          <div class="container">
                  ...
                  <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                    ...
                    <?php foreach($dados as $dado){ ?>
                      <tr>
                        ...
                        <td><a href="../../controller/funcionarios/excluirFuncionarios.php?id=<?php echo $dado['FUN_ID'];?>"><span class='bi bi-trash'></span></a></td>
                        <td><a href="view_editarFuncionario.php?id=<?php echo $dado['FUN_ID'];?>"><span class='bi bi-pencil-square'></span></a></td>
                        <td><a href="visualizarFuncionarios.php?id=<?php echo $dado['FUN_ID'];?>"><span class='bi bi-eye'></span></a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
            ...
            <div class="text-center">
              <a href="novoFuncionario.php">
                <button style="border:none;" class="appointment-btn scrollto">Cadastrar Funcionário</button>
              </a>
            </div>
          </div>
        </div>
