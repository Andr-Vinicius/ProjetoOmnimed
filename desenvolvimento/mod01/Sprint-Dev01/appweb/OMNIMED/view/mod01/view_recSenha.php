        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>Para recuperar a sua senha, informe seu email/prontuário abaixo.</p>
                </div>

                <form action="../../controller/Login/EmailRecSenha.php" method="post" role="form" class="php-email-form" style="align-items: center;">
            ...
            <div class="text-center mt-5" style="margin-right: 5%;">
                <button type="submit"
                    style="width: 20%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Enviar email</button>
