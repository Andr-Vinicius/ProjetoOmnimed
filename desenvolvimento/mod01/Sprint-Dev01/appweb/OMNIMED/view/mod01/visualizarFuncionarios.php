<?php
    ...
    $dados = $dao->listarFuncionario($funcionario);
?>
              ...
              <ul>
                <li class="dropdown"><a href="#"><span>Médico</span> <i class="bi bi-chevron-right"></i></a>
                  <ul>
                    ...
                    <li><a href="listagemMedicos.html">Ver
                        Médicos</a></li>
                  ...
                  <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                    ...
                    <?php foreach($dados as $dado){ ?>
                      <tr>
                        ...
                        ?></td>
                        <td><?php echo $dado['USC_RG'];?></td>
                        <td><?php echo $dado['USC_ORGAO_EMISSOR'];?></td>
                        <td><?php echo $dado['USC_LOGRADOURO'];?></td>
                        <td><?php echo $dado['USC_NUMERO'];?></td>
                        <td><?php echo $dado['USC_BAIRRO'];?></td>
                        <td><?php echo $dado['USC_CIDADE'];?></td>
                        <?php $estado = ""; switch($dado['USC_ESTADO']){
                              case 1:
                                $estado = "Acre";
                                break;
                              case 2:
                        ...
                        <td><?php echo $dado['FUN_PRONTUARIO'];?></td>
                        <?php if($dado['ADM_CRM']!= ''){ ?>
                          <td><?php echo $dado['ADM_CRM'];?></td>
                        <?php } else{ ?>
                          <td><?php echo $dado['USC_CPF'];?></td>
                        <?php } ?>
                        <td><?php echo $dado['ADM_TELEFONE_CELULAR'];?></td>
                        <?php $funcao = ""; switch($dado['ADM_FUNCAO']){
                                case 1:
                                  if($dado['USC_SEXO'] == 2){
                                    $funcao = "Médica";
                                  }else{
                        ...
                        <td><?php echo $dado['ADM_DATA_ADMISSAO'];?></td>
                        <?php if($dado['ADM_DATA_DEMISSAO']!= '0000-00-00'){ ?>
                        <?php } else{ ?>
                        <td><?php echo "Trabalhando";?></td>
                        <?php } ?>
                        <td><?php echo $dado['ADM_SALARIO'];?></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
