...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="/agendamentos/novo" class="appointment-btn scrollto"><span class=" d-md-inline">Agendar CONSULTA</span></a>
            ...
            <div class="container">
                ...
                <form name="form_login" action="/login/logar" method="post" role="form" class="php-email-form" style="align-items: center;">
                    ...
                    <div class="text-center mt-5" style="margin-right: 5%;">
                        <button type="submit" style="background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Acessar</button>
                        <a href="view_formUsuario.html" style="background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Cadastre-se</a>
                    </div>
                </form>
