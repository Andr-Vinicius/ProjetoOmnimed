...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="" class="appointment-btn scrollto"><span class=" d-md-inline">Perfil</span></a>
            <a href="/logout" class="appointment-btn scrollto" style="margin-left: 1%;"><span class=" d-md-inline">Sair</span></a>
    ...
    <main id="main">
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="w-100 p-3">
                    <a href="/planos/novo" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Cadastro de Planos</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/remedios/novo" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Cadastro de Remédios</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/agendamentos/listagem_solicitados" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Confirmação de Atendimentos Online</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/exames/listagem_solicitados" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Confirmação de Exames</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/remedios/listagem_disponivel" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                            <h4>Estoque de Remédios</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/funcionarios/listagem" class="perfilLogado">
                        <div class="icon-box">
                ...
                <div class="w-100 p-3">
                    <a href="/pacientes/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                ...
                <div class="w-100 p-3">
                    <a href="/contatos_setoriais/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                            <h4>Gestão de Contatos Setoriais</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/planos/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Planos</h4>
                            <p></p>
                ...
                <div class="w-100 p-3">
                    <a href="/remedios/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Remédios</h4>
                            <p></p>
                ...
                <div class="w-100 p-3">
                    <a href="/finalidades/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Finalidades</h4>
                            <p></p>
                ...
                <div class="w-100 p-3">
                    <a href="/beneficios/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Benefícios</h4>
                            <p></p>
              ...
              <div class="icon-box">
                ...
                <h4><a href="">Direcionamento a um Especialista sobre os Sintomas</a></h4>
              </div>
            </div>-->

                <div class="w-100 p-3">
                    <a href="/consulta/listagem_historico" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                            <h4>Visualizar Histórico de Atendimentos</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/pagamentos/pacientes" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                            <h4>Pagamentos dos Planos (Pacientes)</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="w-100 p-3">
                    <a href="/pagamentos/medicos" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-clipboard"></i></div>
                            <h4>Pagamentos Médicos</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-clipboard"></i></div>
                  <h4><a href="">Listagem dos Atendimentos direcionados para Consultas Presenciais </a></h4>
                </div>
              </div>-->
                ...
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-clipboard"></i></div>
                  <h4><a href="">Autorização de Exames Solicitados</a></h4>
                </div>
              </div>-->
