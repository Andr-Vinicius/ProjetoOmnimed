...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            ?>
                <a href="/login" class="appointment-btn scrollto" style="margin-left: 1%;"><span class=" d-md-inline">Acessar</span></a>
                <a href="/pacientes/novo" class="appointment-btn scrollto" style="margin-left: 1%;"><span class=" d-md-inline">Cadastrar</span></a>
            <?php
            } else {
            ?>
                <a href="/pacientes/logado" class="appointment-btn scrollto" style="margin-left: 1%;"><span class=" d-md-inline">Perfil</span></a>
            <?php
            }
            ?>
        </div>
