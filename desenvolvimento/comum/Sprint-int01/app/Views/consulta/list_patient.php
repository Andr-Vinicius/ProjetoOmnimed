...
$consultas = new ConsultasOnline();
$consultasModel = new ConsultasOnlineModel();
$consultas = $consultasModel->listarConsultasUltimos30Dias($_SESSION['usuario']['id']);
?>
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <div class="section-title margem">
                    <h2>Consultas dos últimos 30 dias</h2>
                </div>
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($consultas as $key => $consulta) { ?>
                                            <tr>
                                                <td><?php echo $consulta->CNS_ID; ?></td>
                                                <td><?php echo $consulta->CNS_DATA; ?></td>
                                                <td><?php echo $consulta->USC_NOME; ?></td>
                                                <td><?php echo $consulta->ESM_DESCRICAO; ?></td>
                                                <td><a href="detalhar/<?php echo $consulta->CNS_ID; ?>">Detalhar</a></td>
                                            <?php } ?>
                                    </tbody>
                                </table>
                            </div>
