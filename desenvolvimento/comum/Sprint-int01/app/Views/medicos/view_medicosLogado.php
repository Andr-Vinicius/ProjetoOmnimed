...
session_start();
// Somente Médicos podem acessar a página.
// Checa primeiro se está logado, caso não, redireciona pra login;
// Depois checa se está logado e é um Médico. Caso não, redireciona pro index.
if (!isset($_SESSION["usuario"])) {
    ...
    header("Location: /");
    exit;
} elseif (substr($_SESSION["usuario"]["prontuario"], 0, 2) !== "ME") {
    ...
    <main id="main">
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <!--As partes a seguir foram comentadas, uma vez que não fazem sentido como funcionalidades para médicos, além  de que algumas 
          não existem mais no projeto atualmente-->
                <!--<div class="w-100 p-3">
            <div class="icon-box">
              <div class="icon"><i class="fas fa-user-plus"></i></div>
              <h4><a href="/funcionarios/listagem">Gestão dos Funcionarios</a></h4>
              <p></p>
            </div>
          </div>-->
            ...
            <div class="icon-box">
              ...
              <h4><a href="/contatos_setoriais/listagem">Gestão de Contatos Setoriais</a></h4>
            </div>
          </div>-->
                ...
                <div class="w-100 p-3">
                    <a href="/agendamentos/listagem" class="perfilLogado">
                        <div class="icon-box">
                            <div class="icon"><i class="fas fa-prescription-bottle"></i></div>
                            <h4>Listagem de Atendimentos Online</h4>
                            <p></p>
                        </div>
                    </a>
                </div>
              ...
              <div class="icon-box">
                ...
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-clipboard"></i></div>
                  <h4><a href="">Solicitação de Encaminhamentos ou Não para Consultas Presenciais </a></h4>
                </div>
              </div>
              ...
              <div class="w-100 p-3">
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-clipboard"></i></div>
                  <h4><a href="">Listagem dos Atendimentos irecionados para Consultas Presenciais</a></h4>
                </div>
              </div>-->
