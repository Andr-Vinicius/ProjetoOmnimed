    ...
    <main id="main">
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <form action="/agendamentos/salvar" method="post" role="form" class="php-email-form">

                    <input type="hidden" name="AGD_STATUS" id="status" value="1">
                    <input type="hidden" name="AGD_HORARIO" id="horario" value="<?php echo time(); ?>">
                    <input type="hidden" name="AGD_MEET_LINK" id="meetlink" value="">
                    <input type="hidden" name="FK_MEDICOS_MED_ID" id="medicoid" value="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            <input type="date" name="AGD_DATA" class="form-control datepicker" id="dataconsulta" min="<?php echo date('Y-m-d'); ?>" required>
                            <div class="validate"></div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group mt-3 mt-md-0">
                            <input type="textarea" name="AGD_MOTIVO_ENCAMINHAMENTO" class="form-control" id="motivoencaminhamento" placeholder="Motivo do Encaminhamento" disabled>
                            <div class="validate"></div>
                        </div>
                    </div>
                    ...
                    <div class="text-center"><button type="submit" id="cadastrarAgendamento">Cadastrar Agendamento</button></div>
                </form>
    ...
    <script>
        ...
        btnEncaminhamentoSim.addEventListener("click", () => {
            if (btnEncaminhamentoSim.checked) {
                ...
                $("#motivoencaminhamento").prop("required", true);
            }
        })
        ...
        btnEncaminhamentoNao.addEventListener("click", () => {
            if (btnEncaminhamentoNao.checked) {
                ...
                $("#motivoencaminhamento").prop("required", false);
            }
        })

        const btnEncaminhamentoPresencialSim = document.querySelector('#encaminhamentoPresencialSim');
        btnEncaminhamentoPresencialSim.addEventListener("click", () => {
            if (btnEncaminhamentoPresencialSim.checked) {
                $("#retornoNao").prop("checked", true);
