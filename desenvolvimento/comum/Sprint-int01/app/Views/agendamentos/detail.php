            ...
            <div class="container">
                ...
                <form action="" method="post" role="form" class="php-email-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-2">
                            <a href="/agendamentos/listagem" class="appointment-btn scrollto"><span class=" d-md-inline">Voltar</a>
                        </div>

                        <div class="col-md-3 mt-2">
                            <?php if ($agendamento->AGD_STATUS == 1) { ?>
                                <a href="/agendamentos/editar/<?php echo $id; ?>" class="appointment-btn scrollto"><span class=" d-md-inline">Editar</a>
                            <?php } ?>
                        </div>

                        <div class="col-md-3 mt-2">
                            <?php if (isset($_SESSION['usuario']['prontuario'])) { ?>
                                <a href="/consultas/novo" class="appointment-btn scrollto"><span class=" d-md-inline">Consulta</a>
                            <?php } ?>
                        </div>
                    </div>
