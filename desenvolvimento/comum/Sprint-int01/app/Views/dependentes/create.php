...
session_start();
// Somente Pacientes podem acessar a página.
// Checa primeiro se está logado, caso não, redireciona pra login;
// Depois checa se está logado e é um Paciente. Caso não, redireciona pro index.
...
$FK_RESPONSAVEL_RES_ID = $_SESSION["usuario"]['id'];
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="/agendamentos/novo" class="appointment-btn scrollto"><span class=" d-md-inline">Agendar
                    CONSULTA</span></a>
        </div>
    </header><!-- End Header -->
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>Para cadastrar seu dependente, preencha os campos abaixo com as suas informações.</p>
                </div>

                <form action="/dependentes/salvar" method="post" role="form" class="php-email-form">

                    <div class="row">
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            <input name="RES_ID" value="<?php echo $FK_RESPONSAVEL_RES_ID ?>" hidden>
                            Nome Completo
                            <input type="text" name="USC_NOME" class="form-control" id="nome_dependente" placeholder="Nome Completo" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-2 form-group mt-3 mt-md-0">
                            Data de Nascimento
                            <input type="date" name="USC_DATA_NASCIMENTO" id="nascimento_dependente" class="form-control datepicker" id="birthdate" placeholder="Data de Nascimento" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-2 form-group mt-3 mt-md-0">
                            Sexo
                            <select name="USC_SEXO" id="sexo_dependente" class="form-select">
                        ...
                        <div class="col-md-2 form-group mt-3 mt-md-0">
                            Parentesco
                            <select name="DEP_NV_PARENTESCO" id="nivel_parentesco" class="form-select">
                                <option value="">Selecione...</option>
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            CPF
                            <input type="text" class="form-control" name="USC_CPF" id="cpf_dependente" placeholder="CPF" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-4">
                            RG
                            <input type="text" class="form-control" name="USC_RG" id="rg_dependente" placeholder="RG" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-4 form-group mt-3 mt-md-0">
                            Orgão Emissor
                            <input type="text" class="form-control" name="USC_ORGAO_EMISSOR" id="orgaoemissor_dependente" placeholder="Orgão Emissor" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                            <div class="validate"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 form-group mt-3 mt-md-0">
                                Logradouro
                                <input type="text" class="form-control" name="USC_LOGRADOURO" id="logradouro_dependente" placeholder="Logradouro" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Número
                                <input type="text" class="form-control" name="USC_NUMERO" id="numero_dependente" placeholder="Número" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Bairro
                                <input type="text" class="form-control" name="USC_BAIRRO" id="bairro_dependente" placeholder="Bairro" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Cidade
                                <input type="text" class="form-control" name="USC_CIDADE" id="cidade_dependente" placeholder="Cidade" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                <label for="Estado">Estado</label>
                                <select name="USC_ESTADO" id="estado_dependente" class="form-select">
                                    <option value="">Selecione...</option>
                ...
                <div class="text-center" style="padding-top: 20px">
                    <a href="/dependentes/listagem">
                        <button style="border:none; margin: 0 auto;" class="appointment-btn scrollto">
                            Voltar
                        </button>
                    </a>
                </div>
