...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="formConsulta.html" class="appointment-btn scrollto"><span class=" d-md-inline">Marque uma
                </span>
                CONSULTA</a>
    ...
    <main id="main">
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <form action="/recuperar_senha/enviar_email" method="POST" role="form" class="php-email-form" style="align-items: center;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="sent-message">Email enviado com sucesso!</div>
                    </div>
                    <div class="text-center mt-5" style="margin-right: 5%;">
                        <button type="submit" style="background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Enviar email</button>
                        <a href="/" style="background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Cadastre-se</a>
                    </div>
                </form>
