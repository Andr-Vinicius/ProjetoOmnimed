        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <?php } else { ?>
                        <h2>Link Expirado</h2>
                        <p>Para recuperar a sua senha, requisite um novo link!</p>
                    <?php } ?>
                </div>

                <?php if ($expired == 'true') { ?>
                    <form action="/recuperar_senha/confirmarSenha/<?php echo $hash; ?>" method='POST' role="form" class="php-email-form" style="align-items: center;">
